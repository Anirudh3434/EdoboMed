...
const EdoboPlusHeaderComponent = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg  container-fluid fixed-top">
        ...
        <span className="logo">edobo<span style={{color: ' rgb(2, 185, 2)'}}>+</span></span>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto align-items-center flex-grow-1">
              ...
              <li className="nav-item flex-grow-1 d-flex justify-content-end">
                <div class="input-group" style={{ width: '40%',position: "relative", marginRight: '20px' }}>
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Search medcine at Edobo+"
                    aria-label="Username"
...
export default EdoboPlusHeaderComponent;
